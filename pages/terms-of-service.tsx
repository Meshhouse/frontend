...
class TermsOfService extends PureComponent<any, any> {
  static Layout: ({ children }: { children: any; }) => JSX.Element;

  static async getInitialProps(): Promise<any> {
    return {
      namespacesRequired: ['pages-terms-of-service']
    };
  }
        ...
        <Container>
          <Row>
            <Col>
              ...
              <p>We reserve the right to modify this Agreement or its terms relating to the Website and Services at any time, effective upon posting of an updated version of this Agreement on the Website. When we do, we will send you an email to notify you. Continued use of the Website and Services after any such changes shall constitute your consent to such changes. Policy was created with <a target="_blank" rel="noreferrer" href="https://www.websitepolicies.com/blog/sample-terms-conditions-template">WebsitePolicies</a>.</p>
              ...
              <h2>Contacting us</h2>
              <p>If you would like to contact us to understand more about this Agreement or wish to contact us concerning any matter relating to it, you may send an email to sup&#112;or&#116;&#64;&#109;e&#115;h&#104;&#111;&#117;&#115;e&#46;a&#114;&#116;</p>
...
TermsOfService.Layout = withLayout;

export default withTranslation('pages-terms-of-service')(TermsOfService);
